...
export type RegularErorrFragment = (
  { __typename?: 'FieldError' }
...
export const PostSnippetFragmentDoc = gql`
  ...
  creator {
    ...
    `;
export const RegularErorrFragmentDoc = gql`
    fragment RegularErorr on FieldError {
  field
  message
}
    `;
